 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(O,q){var Y=O.length;O.push(q);e:for(;0<Y;){var me=Y-1>>>1,_e=O[me];if(0<r(_e,q))O[me]=q,O[Y]=_e,Y=me;else break e}}function n(O){return O.length===0?null:O[0]}function i(O){if(O.length===0)return null;var q=O[0],Y=O.pop();if(Y!==q){O[0]=Y;e:for(var me=0,_e=O.length,se=_e>>>1;me<se;){var k=2*(me+1)-1,N=O[k],P=k+1,b=O[P];if(0>r(N,Y))P<_e&&0>r(b,N)?(O[me]=b,O[P]=Y,me=P):(O[me]=N,O[k]=Y,me=k);else if(P<_e&&0>r(b,Y))O[me]=b,O[P]=Y,me=P;else break e}}return q}function r(O,q){var Y=O.sortIndex-q.sortIndex;return Y!==0?Y:O.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],d=1,h=null,f=3,g=!1,y=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(O){for(var q=n(c);q!==null;){if(q.callback===null)i(c);else if(q.startTime<=O)i(c),q.sortIndex=q.expirationTime,e(l,q);else break;q=n(c)}}function E(O){if(x=!1,p(O),!y)if(n(l)!==null)y=!0,J(R);else{var q=n(c);q!==null&&ee(E,q.startTime-O)}}function R(O,q){y=!1,x&&(x=!1,u(H),H=-1),g=!0;var Y=f;try{for(p(q),h=n(l);h!==null&&(!(h.expirationTime>q)||O&&!W());){var me=h.callback;if(typeof me=="function"){h.callback=null,f=h.priorityLevel;var _e=me(h.expirationTime<=q);q=t.unstable_now(),typeof _e=="function"?h.callback=_e:h===n(l)&&i(l),p(q)}else i(l);h=n(l)}if(h!==null)var se=!0;else{var k=n(c);k!==null&&ee(E,k.startTime-q),se=!1}return se}finally{h=null,f=Y,g=!1}}var T=!1,A=null,H=-1,w=5,C=-1;function W(){return!(t.unstable_now()-C<w)}function j(){if(A!==null){var O=t.unstable_now();C=O;var q=!0;try{q=A(!0,O)}finally{q?he():(T=!1,A=null)}}else T=!1}var he;if(typeof _=="function")he=function(){_(j)};else if(typeof MessageChannel<"u"){var z=new MessageChannel,Q=z.port2;z.port1.onmessage=j,he=function(){Q.postMessage(null)}}else he=function(){m(j,0)};function J(O){A=O,T||(T=!0,he())}function ee(O,q){H=m(function(){O(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(O){O.callback=null},t.unstable_continueExecution=function(){y||g||(y=!0,J(R))},t.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<O?Math.floor(1e3/O):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(O){switch(f){case 1:case 2:case 3:var q=3;break;default:q=f}var Y=f;f=q;try{return O()}finally{f=Y}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(O,q){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var Y=f;f=O;try{return q()}finally{f=Y}},t.unstable_scheduleCallback=function(O,q,Y){var me=t.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?me+Y:me):Y=me,O){case 1:var _e=-1;break;case 2:_e=250;break;case 5:_e=1073741823;break;case 4:_e=1e4;break;default:_e=5e3}return _e=Y+_e,O={id:d++,callback:q,priorityLevel:O,startTime:Y,expirationTime:_e,sortIndex:-1},Y>me?(O.sortIndex=Y,e(c,O),n(l)===null&&O===n(c)&&(x?(u(H),H=-1):x=!0,ee(E,Y-me))):(O.sortIndex=_e,e(l,O),y||g||(y=!0,J(R))),O},t.unstable_shouldYield=W,t.unstable_wrapCallback=function(O){var q=f;return function(){var Y=f;f=q;try{return O.apply(this,arguments)}finally{f=Y}}}})(s_);r_.exports=s_;var uS=r_.exports;/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wc=new Zy("@firebase/auth");function KP(t,...e){Wc.logLevel<=at.WARN&&Wc.warn(`Auth (${Ao}): ${t}`,...e)}function oc(t,...e){Wc.logLevel<=at.ERROR&&Wc.error(`Auth (${Ao}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const UI="__/auth/handler",OI="emulator/auth/handler",kI=encodeURIComponent("fac");async function Ov(t,e,n,i,r,s){je(t.config.authDomain,t,"auth-domain-config-required"),je(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:i,v:Ao,eventId:r};if(e instanceof vp){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",OR(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[d,h]of Object.entries({}))o[d]=h}if(e instanceof qa){const d=e.getScopes().filter(h=>h!=="");d.length>0&&(o.scopes=d.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const d of Object.keys(a))a[d]===void 0&&delete a[d];const l=await t._getAppCheckToken(),c=l?`#${kI}=${encodeURIComponent(l)}`:"";return`${FI(t)}?${Xa(a).slice(1)}${c}`}function FI({config:t}){return t.emulator?hp(t,OI):`https://${t.authDomain}/${UI}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
